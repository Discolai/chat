...
/**
 * Builds and executes requests for operations under /api/conversations/{conversationId}/messages
 */
 ...
 */
export const MessagesRequestBuilderUriTemplate = "{+baseurl}/api/conversations/{conversationId}/messages";
/**

...
/**
 * Builds and executes requests for operations under /api/users/{userId}/conversations
 */
export interface ConversationsRequestBuilder extends BaseRequestBuilder<ConversationsRequestBuilder> {
    /**
     * Gets an item from the ApiSdk.api.users.item.conversations.item collection
 ...
 */
export const ConversationsRequestBuilderUriTemplate = "{+baseurl}/api/users/{userId}/conversations";
/**
